"""
Daily Breakout Scanner - MODERATE Parameters

Moderate version balancing selectivity with opportunity:
- Average volume OK (1.0x vs 1.2x)
- Moderate distance from 52w high (35% vs 25%)
- Week-long bases (7d vs 10d)
- Moderate volatility (15% vs 12%)

Target: 25-50 trades over 6 months
...
@register_scanner('daily_breakout_moderate')
class DailyBreakoutScannerModerate:
    """
    ...
    def __init__(self, api_key: str, secret_key: str, universe: str = 'default'):
        ...
        # Screening criteria - MODERATE
        self.min_consolidation_days = 7   # Week-long bases
        self.max_consolidation_days = 90  # At most 3 months
        self.min_volume_ratio = 1.0       # Average volume OK
        self.max_distance_from_high = 35  # Moderate mid-Stage 2
        self.min_price = 10.0             # Avoid penny stocks
        self.max_base_volatility = 0.15   # Moderate volatility tolerance
    ...
    def strategy_name(self) -> str:
        ...
        return 'daily_breakout_moderate'
