"""
Daily Breakout Scanner - VERY RELAXED Parameters

Very relaxed version for maximum opportunity:
- Minimal volume filter (0.5x - almost none)
- Very wide distance from 52w high (50%)
- Ultra-short bases (3d minimum)
- High volatility OK (25%)

Target: 100+ trades over 6 months (may include noise)
...
@register_scanner('daily_breakout_very_relaxed')
class DailyBreakoutScannerVeryRelaxed:
    """
    ...
    def __init__(self, api_key: str, secret_key: str, universe: str = 'default'):
        ...
        # Screening criteria - VERY RELAXED
        self.min_consolidation_days = 3   # Ultra-short bases
        self.max_consolidation_days = 90  # At most 3 months
        self.min_volume_ratio = 0.5       # Almost no volume filter
        self.max_distance_from_high = 50  # Very wide range
        self.min_price = 10.0             # Avoid penny stocks
        self.max_base_volatility = 0.25   # High volatility OK
    ...
    def strategy_name(self) -> str:
        ...
        return 'daily_breakout_very_relaxed'
