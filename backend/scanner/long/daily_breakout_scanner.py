"""
Daily Breakout Scanner - Minervini/O'Neil Style

Scans for stocks breaking out of consolidation bases with:
- Strong price trend (20-day, 50-day moving averages)
- Volume expansion on breakout
- Consolidation near 52-week highs
- Tight price pattern before breakout

This is what Mark Minervini and William O'Neil used to make millions.
...
class DailyBreakoutScanner:
    ...
    def __init__(self, api_key: str, secret_key: str, universe: str = 'default'):
        ...
        self.min_volume_ratio = 1.2  # 1.2x average volume (industry standard)
        self.max_distance_from_high = 25  # Within 25% of 52-week high
